...
public class VoicemailSettingsActivity extends PreferenceActivity
    ...
    protected void onResume() {
        ...
        if (mMwiNotification != null) {
            if (getResources().getBoolean(R.bool.sprint_mwi_quirk)) {
                ...
                int mwiNotificationEnabled = MKSettings.System.getInt(getContentResolver(),
                        MKSettings.System.ENABLE_MWI_NOTIFICATION, 0);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mSubMenuVoicemailSettings) {
            ...
            MKSettings.System.putInt(mPhone.getContext().getContentResolver(),
